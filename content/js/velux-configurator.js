		...
		mmc.dom.complete.on({
			...
			mouseleave: function () {
				mmc.trigger.leave = function () {
					...
					mmc.trigger.timeout = setTimeout(function () { mmc.trigger.target.click(); delete mmc.trigger.timeout; delete mmc.trigger.enter; delete mmc.trigger.leave; }, 1000);
				};
				mmc.trigger.leave();
			}
